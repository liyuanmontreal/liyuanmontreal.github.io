...
[图1](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_1.jpg)

[图2](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_2.png)

[图3](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_3.jpg)

[图4](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_4.jpg)

[图5](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_5.jpg)
...
拥有GitHub账号后，用户可以创建不同的repository来托管不同的项目。这里我们需要创建一个repository来存放个人网站的数据。
  ...
  [图6](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_6.jpg)
  
  这里需要为repository指定名称。我们可以输入用户名。
用户名.github.io，这将是未来个人网站的访问地址。
  
  [图7](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_7.jpg)
...
### step 3: set GitPage templete
 选择Setting
   ...
   [图8](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_8.jpg)
  
  找到GitPage配置页面
  
 [图9](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_9.jpg)
  
  设置source，选择博客主题
  
   [图10](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_10.jpg)
...
### step 4: update your website files
  ...
  流程如下：
   ...
   3. 使用 git clone 地址 命令将GitHub端的repository目录下的文件全部获取到本地。
      ...
      [图11](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_11.jpg)    
...
### step1： 使用GitHub账号登录GitPress
 ...
 [图12](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_12.jpg)

### step2: 设置Repository

 在welcome窗口中选择个人网站所在的Repository.此处如果设置为/则表示博客文章都存放在根目录中。我们也可以将博客文档放置在一个单独的子目录中如article.此处则需要相应设置为/article/

 [图13](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_13.jpg)

### step3: 添加webhook
  
  由于 GitPress 是使用 webhook 的方式来同步 GitHub 上的文章，因此接下来会出现一个窗口，提示用户需要允许 GitPress 将 webhook 添加到 GitHub 仓库上。

   [图14](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_14.jpg)

至此，就搭建完成了。完成后的界面如下。

 [图15](https://github.com/liyuanmontreal/liyuanmontreal.github.io/tree/main/articles/article_15.jpg)
